...
<div class="container">
	<div class="card">
		<div class="card-body">
			<ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" data-bs-toggle="tab" href="#general" role="tab" title="Datos Generales">
					...
					<form id="frm-general" enctype="multipart/form-data">
						<div class="row" style="background-color:#cafad7;">
							<div class="col-xs-12 col-sm-12 col-md-3 mb-3">
								...
								<input type="date" class="form-control req row_back1" id="fecha_reserva" name="fecha_reserva" tabindex="1">
								<div class="requerido" id="err_fecha_reserva"></div>
								<label for="hora_reserva" class="col-form-label">Hora<span class="requerido">*</span></label>
								<input type="time" class="form-control req row_back1" id="hora_reserva" name="hora_reserva" tabindex="2">
								...
								<input type="text" class="form-control req row_back1" id="pasajeros" name="pasajeros" tabindex="3">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<div class="input-group">
											<input type="text" class="form-control req row_back1" list="listaClientes" id="cliente"
												placeholder="Escriba para buscar..." tabindex="5">
											<div class="input-group-append">
												<span class="input-group-text">
													<i class="fas fa-eye hist_cli" data-bs-target="#mdl-historial" data-bs-toggle="modal"
														style="cursor:pointer;display:none;" title="Historial de reservas del cliente"
														id="cons_res"></i>&nbsp;&nbsp;<span id="noshow_cliente" class="hist_cli"
														title="Cantidad de No Show del cliente en los últimos 6 meses"></span>&nbsp;&nbsp;
													<i class="fas fa-user-edit hist_cli" data-bs-target="#mdl-cliente" data-bs-toggle="modal"
														style="cursor:pointer;display:none;" title="Editar cliente" id="cons_cli"></i>
										...
										<input type="text" class="form-control row_back1" list="listaEmpresas" id="empresa"
											placeholder="Escriba para buscar..." tabindex="6">
										<datalist id="listaEmpresas">
										</datalist>
										<label for="hotel" class="col-form-label">Hotel</label>
										<input type="text" class="form-control row_back1" list="listaHoteles" id="hotel"
											placeholder="Escriba para buscar..." tabindex="7">
										<datalist id="listaHoteles">
										</datalist>
										<label for="telefono" class="col-form-label">Teléfono<span class="requerido">*</span></label>
										<input type="text" class="form-control req row_back1" list="listaTelefonos" id="telefono"
										...
										<input type="text" class="form-control row_back1" list="listaCorreos" id="correo"
											placeholder="Escriba para buscar..." tabindex="9">
										<span class="requerido" id="err_correo"></span>
										<datalist id="listaCorreos">
										</datalist>
										<input type="text" class="form-control row_back1" id="correo1" placeholder="Escriba para buscar..."
											style="display:none;">
										<hr style="visibility: hidden;" />
									</div>
								</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-3" style="background-color:#a9c9fc;">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<select id="sucursal" name="sucursal" class="form-control req" tabindex="10"></select>
										<div class="requerido" id="err_sucursal"></div>
										<label for="salon" class="col-form-label">Salón</label>
										<select id="salon" name="salon" class="form-control text text-sm crear" tabindex="11"></select>
										<div class="requerido" id="err_salon"></div>
										<label for="mesa" class="col-form-label">Mesa</label>
										<select id="mesa" name="mesa" class="form-control text text-sm crear" tabindex="12">

                                        </select>
										<div class="requerido" id="err_mesa"></div>
										</datalist>
										<label for="observaciones" class="col-form-label">Observaciones</label>
										<textarea id="observaciones" name="observaciones" class="form-control text text-sm crear" rows="10" tabindex="13"></textarea>
										<hr style="visibility: hidden;" />
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="menu1" name="menu1" accept=".pdf,.png,.jpg,.jpeg" />
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="menu2" name="menu2" accept=".pdf,.png,.jpg,.jpeg">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="precuenta" name="precuenta">
                                            <button type="button" class="btn btn-danger clear_precuenta mx-2 btn-sm">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="factura" name="factura" accept=".pdf,.png,.jpg,.jpeg">
                                            <button type="button" class="btn btn-danger clear_factura mx-2 btn-sm">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="logo" name="logo" accept=".pdf,.png,.jpg,.jpeg">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" class="form-control" id="otro" name="otro" accept=".pdf,.png,.jpg,.jpeg">
						...
						<div class="row" style="background-color:#cafad7;">
							<div class="col-xs-12 col-sm-12 col-md-2">
								...
								<input type="text" class="form-control row_back1" id="nombre_adicional" name="nombre_adicional"
									placeholder="Introduzca nombre adicional">
								<div class="requerido" id="err_nombre_adicional"></div>
								<label for="pax" class="col-form-label">Pax</label>
								<input type="text" class="form-control row_back1" id="pax" name="pax"
									placeholder="Introduzca Pax">
								...
								<input type="text" class="form-control row_back1" id="nombre_contacto" name="nombre_contacto"
									placeholder="Introduzca nombre contacto">
								<div class="requerido" id="err_pasajros"></div>
								...
								<input type="text" class="form-control row_back1" id="telefono_contacto" name="telefono_contacto"
									placeholder="Introduzca telefono contacto">
								<div class="requerido" id="err_tipo"></div>
								...
								<input type="text" class="form-control row_back1" id="correo_contacto" name="correo_contacto"
									placeholder="Introduzca correo contacto">
								<div class="requerido" id="err_tipo"></div>
								<label for="idioma">Idioma</label><br />
								<input type="text" class="form-control row_back1" id="idioma" name="correo_contacto">
								<hr style="visibility: hidden;" />
							</div>
							<div class="col-xs-12 col-sm-12 col-md-3" style="background-color:#f8faca;">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control row_back1" id="anticipo" placeholder="Introduzca el monto del anticipo">											
										</div>

										<label for="valor_menu" class="col-form-label">Valor Menú</label>
										<div class="input-group">
											<div class="input-group-text" id="btnGroupAddon1">$</div>
											<input type="text" class="form-control row_back1" id="valor_menu" placeholder="Introduzca el valor del menú">
										</div>

										<label for="total_s_propina" class="col-form-label">Total sin Propina</label>
										<div class="input-group">
											<div class="input-group-text" id="btnGroupAddon2">$</div>
											<input type="text" class="form-control" id="total_s_propina" placeholder="Introduzca el total sin propina">
										</div>
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" id="total_c_propina" placeholder="Introduzca el total con propina">
										</div>
										<div class="requerido" id="err_total_s_propina"></div>
							...
							<div class="col-xs-12 col-sm-12 col-md-2" style="background-color:#a9c9fc;">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<select id="audio" name="audio" class="form-control text text-sm crear">
											<option value="" disabled selected>Seleccione</option>
											<option value="1">SI</option>
											<option value="2">NO</option>
										</select>
										...
										<select id="video" name="video" class="form-control text text-sm crear">
											<option value="" disabled selected>Seleccione</option>
											<option value="1">SI</option>
											<option value="2">NO</option>
										</select>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										<div id="dvextras" style="display:none;">
											...
											<label for="telefono_autoriza" class="col-form-label">Teléfono Autoriza<span
													class="requerido">*</span></label>
											<input type="text" class="form-control row_back1 req" id="telefono_autoriza"
												placeholder="N° de teléfono de quién autoriza">
											<div class="requerido" id="err_telefono_autoriza"></div>

											<label for="monto_autorizado" class="col-form-label">Monto Máximo<span class="requerido">*</label>
											<div class="input-group">
												<div class="input-group-text" id="btnGroupAddon1">$</div>
												<input type="number" class="form-control row_back1 req" id="monto_autorizado" placeholder="Monto máximo autorizado">
											</div>
										...
										<select id="table_tent" name="table_tent" class="form-control text text-sm crear">
											<option value="" disabled selected>Seleccione</option>
											<option value="1">SI</option>
											<option value="2">NO</option>
										</select>
										...
										<select id="restriccion" name="restriccion" class="form-control text text-sm crear">
											<option value="" disabled selected>Seleccione</option>
											<option value="1">SI</option>
											<option value="2">NO</option>
										</select>
	...
	{{-- ********************************** --}}
	<!-- Modal mdl-historial-->
	<div class="modal fade" id="mdl-historial" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="table-responsive mt-4">
						<table id="cli_reservas_tbl" class="table table-stripped" data-toggle="table" data-id-field="id"
							data-unique-id="id" data-search="true" data-search-align="left" data-height="360" data-pagination="true"
							data-page-list="[10, 25, 50, 100, all]" data-locale="es-CL">
							<thead>
								<tr>
		...
		<div class="modal-dialog modal-dialog-centered modal-xl">
			<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
									<a class="nav-link mb-2 active" id="v-pills-personal-tab" data-bs-toggle="pill" href="#v-pills-personal"
										role="tab" aria-controls="v-pills-personal" aria-selected="true">Datos personales</a>
									<a class="nav-link mb-2" id="v-pills-general-tab" data-bs-toggle="pill" href="#v-pills-general"
										role="tab" aria-controls="v-pills-general" aria-selected="false">Datos Generales</a>
								</div>
							</div>
										...
										<div class="row align-items-start">
											<div class="col-sm-12 col-xs-12 col-md-3">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="crut" name="crut"
											...
											<div class="col-sm-12 col-xs-12 col-md-5">
												<div>
													<label for="cnombre">NOMBRE<span class="requerido">*</span></label><br />
													<input type="text" class="form-control form-control-lg" id="cnombre" name="cnombre"
											...
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="date" class="form-control form-control-lg" id="cfecha_nacimiento"
														name="cfecha_nacimiento" placeholder="Introduzca el RUT del cliente">
												</div>
											</div>
										</div>
										<div class="row align-items-start">
											<div class="col-sm-12 col-xs-12 col-md-3">
												<div>
													<label for="ctelefono">TELÉFONO<span class="requerido">*</span></label><br />
													<input type="text" class="form-control form-control-lg" id="ctelefono" name="ctelefono"
														placeholder="Introduzca el teléfono del cliente" pattern="^\+[0-9]{11}$" required>
											...
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="email" class="form-control form-control-lg" id="cemail" name="cemail"
														placeholder="Introduzca el correo del cliente del cliente" required>
										...
										<div class="row align-items-start">
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="cempresa" name="cempresa"
											...
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="chotel" name="chotel"
										...
										<div class="row align-items-start">
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="cvino1" name="cvino1"
											...
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="cvino2" name="cvino2"
														placeholder="Introduzca el vino favorito del cliente (1) del cliente">
												</div>
											</div>
											<div class="col-sm-12 col-xs-12 col-md-4">
												<div>
													...
													<input type="text" class="form-control form-control-lg" id="cvino3" name="cvino3"
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-secondary" id="btn-cerrarc" data-bs-dismiss="modal" aria-label="Close"
