    ...
    <div class="card">
        <form action="{{ route('comensales.store') }}" method="POST">
            ...
            <div class="card-header">
                <h3>Registro de comensales crear mesa</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    @if (Session::has('message'))
                        <div class="col-12 my-3">
                            <div class="alert alert-success text-center" role="alert">
                                <span> {!! html_entity_decode(session('message')) !!}</span>                               
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email')}}" maxlength="60"/>
                            @error('email')
                                <div class="requerido">{{ $message }}</div>
                            @enderror
                        </div>
